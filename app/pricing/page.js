          ...
          <div className="flex flex-wrap justify-center">
            <div className="p-4">
              <div className="p-6 rounded-lg border-2 border-gray-700 flex flex-col relative overflow-hidden">
                ...
                <h1 className="text-5xl pb-4 mb-4 border-b border-gray-700">
                  <span>$18</span>
                ...
                <button className="btn btn-primary flex items-center mt-auto w-full focus:outline-none rounded">
                  Button
                  <svg
                    fill="none"
                    stroke="currentColor"
            ...
            <div className="p-4">
              <div className="p-6 rounded-lg border-2 border-gray-700 flex flex-col relative overflow-hidden">
                <span className="bg-yellow-400 text-base-300 font-semibold px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl">
                  POPULAR
                </span>
